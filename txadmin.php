...
class plgAjaxTxAdmin extends JPlugin
{

    function onAjaxTxadmin()
    {
        ...
        if ($_POST['data']) {
            ...
            switch ($action) {
                ...
                case 'fontVariants':
                    ...
                    $template_path = JPATH_SITE . '/templates/' . self::getTemplate()->template . '/admin/webfonts/webfonts.json';
                    $plugin_path   = JPATH_PLUGINS . '/ajax/txadmin/assets/webfonts/webfonts.json';
                ...
                case 'updateFonts':
                    ...
                    $template_path = JPATH_SITE . '/templates/' . self::getTemplate()->template . '/admin/webfonts';
                    
                    if(!JFolder::exists( $template_path )) {
                       JFolder::create( $template_path, 0755 );
                    }

                    $url  = 'https://www.googleapis.com/webfonts/v1/webfonts?key=AIzaSyDhGYrOGNyzQCzcZ4JeY86mAnTJN9CTixU';
                    $http = new JHttp();
                    $str  = $http->get($url);
    ...
    static public function resetMenuLayout($current_menu_id = 0){
        ...
        if($no_child === true)
        {
            ...
            echo '<div class="txmenu tx-row">';
            echo '<div class="column tx-col-md-12" data-column="12">';
        ...
        else
        {
            ...
            {
                echo '<div class="column tx-col-md-'.$columnNumber.'" data-column="'.$columnNumber.'">';
                echo '<div class="column-items-wrap">';
    ...
    static public function loadNewLayout($layout_data = null){
        ...
        foreach ($layout_data as $row) {
            ...
            $name = JText::_('TXADMIN_SECTION_TITLE');
           ...
           <div class="settings-section clearfix">
            ...
            <div class="settings-right pull-right">
                <ul class="button-group">
                    <li>
                        <a class="btn btn-small add-columns" href="#"><i class="fa fa-columns"></i> <?php echo JText::_('TXADMIN_ADD_COLUMNS'); ?></a>
                    ...
                    <li><a class="btn btn-small add-row" href="#"><i class="fa fa-bars"></i> <?php echo JText::_('TXADMIN_ADD_ROW'); ?></a></li>
                    <li><a class="btn btn-small row-ops-set" href="#"><i class="fa fa-gears"></i> <?php echo JText::_('TXADMIN_SETTINGS'); ?></a></li>
                    <li><a class="btn btn-danger btn-small remove-row" href="#"><i class="fa fa-times"></i> <?php echo JText::_('TXADMIN_REMOVE'); ?></a></li>
                </ul>
            </div>
            </div>
